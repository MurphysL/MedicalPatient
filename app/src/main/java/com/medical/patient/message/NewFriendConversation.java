...
public class NewFriendConversation extends Conversation {
    ...
    public int getUnReadCount() {
        return NewFriendManager.getInstance(MyApplication.getAppContext()).getNewInvitationCount();
    }

    @Override
    public void readAllMessages() {
        //批量更新未读未认证的消息为已读状态
        NewFriendManager.getInstance(MyApplication.getAppContext()).updateBatchStatus();
    }
