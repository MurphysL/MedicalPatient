...
import com.medical.patient.message.i.QueryUserListener;
import com.medical.patient.message.i.UpdateCacheListener;
...
public class UserModel extends BaseModel {
    ...
    public UserBean getUser(){
        return BmobUser.getCurrentUser(getContext(), UserBean.class);
    }
     ...
     * @param listener
     */
    public void queryUsers(String username, int limit, final FindListener<UserBean> listener){
     ...
     */
    public void agreeAddFriend(UserBean friend,SaveListener listener){
        Friend f = new Friend();
        UserBean user = BmobUser.getCurrentUser(getContext(), UserBean.class);
        f.setUser(user);
